...
options[1]="iTerm2";                devtoolchoices[1]="+"
...
printHeading "Installing Brew Packages"
    ...
    printStep "libpq"                       "brew install libpq"
    printStep "terraform"                   "brew install terraform"
    printStep "awscli"                      "brew install awscli"
    printStep "direnv"                      "brew install direnv"
    printStep "fzf"                         "brew install fzf"
    printStep "jq"                          "brew install jq"
    printStep "wget"                        "brew install wget"
    printStep "rsync"                       "brew install rsync"
    printStep "neovim"                      "brew install neovim"
    printStep "bat"                         "brew install bat"
    printStep "yarn"                        "brew install yarn"
printDivider

printHeading "Installing Brew Casks"
    printStep "ngrok"                       "brew install --cask ngrok"
    printStep "flux"                        "brew install --cask flux"
    ...
    printStep "cleanshot"                   "brew install --cask cleanshot"
    printStep "linear"                      "brew install --cask linear-linear"
printDivider
